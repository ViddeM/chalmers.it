...
# POSTGRES SETTINGS
POSTGRES_USER = os.environ.get('FILEIT_POSTGRES_USER', 'postgres')
POSTGRES_PASSWORD = os.environ.get('FILEIT_POSTGRES_PASSWORD', 'password')
POSTGRES_HOST = os.environ.get('FILEIT_POSTGRES_HOST', 'db')
POSTGRES_PORT = os.environ.get('FILEIT_POSTGRES_PORT', '5432')
POSTGRES_DB = os.environ.get('FILEIT_POSTGRES_DB', 'postgres')
